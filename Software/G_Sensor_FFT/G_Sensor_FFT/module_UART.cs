    ...
    public class UART
    {
        ...
        public byte[] ReceiveData()
        {
            try
            {
                ...
                //{
                //    Console.WriteLine(DateTime.Now.ToString("HH:mm:ss.fff-") + byteCount);
                //    dtTest = dtTest.AddMilliseconds(1000);
                //    byteCount = 0;
                //}
                Console.WriteLine((DateTime.Now - dtTest).TotalMilliseconds.ToString("F4") + "ms-" + dataLen);
                dtTest = DateTime.Now;
        ...
        /// <returns>如目前以開啟ComPort持續接收事件，將不執行命令並回傳False</returns>
